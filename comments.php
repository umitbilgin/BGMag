 ...
 <?php if ('open' == $post->comment_status) : ?>
    <div id="respond">	
		...
		<div class="comment-input-group">
			<div class="comment-input">
				<label>Ad Soyad: <?php if ($req) echo "*"; ?></label>
...
<div id="respond">
    <?php if (have_comments()) : ?>
        ...
        <?php else : ?>
        <?php if ('open' == $post->comment_status) : ?>
			<p class="no-comment"><i class="material-icons"></i> Bu yazıya henüz yorum yapılmamıştır, yazı hakkındaki düşüncelerinizi paylaşmaktan çekinmeyin.</p>
        <?php else : ?>
			<p><i class="material-icons"></i> Bu yazıya yorum yapılması editör tarafından yasaklanmıştır, anlayışınız için teşekkürler.</p>
        <?php endif; ?>
    <?php endif; ?>
</div>
</div>