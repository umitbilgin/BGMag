...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( 'Tema Ayarları', 'theme-textdomain' ),
			'menu_title' => __( 'Tema Ayarları', 'theme-textdomain' ),
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Ayarları Kaydet', 'theme-textdomain' ); ?>" />
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Sıfırla', 'theme-textdomain' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Ayarları sıfırlamak istediğinize emin misiniz ?', 'theme-textdomain' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', __( 'Ayarlar kaydedildi.', 'theme-textdomain' ), 'updated fade' );
	}
